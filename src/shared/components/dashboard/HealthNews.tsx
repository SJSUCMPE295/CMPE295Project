...
ListItemText,Table,TableHead,TableBody,TableRow,TableCell
...
const HealthNews = () => {
    ...
    const newsRssFeed = "https://api.rss2json.com/v1/api.json?rss_url=https%3A%2F%2Fwww.news-medical.net%2Fsyndication.axd%3Fformat%3Drss";
...
//}, [MAX_ARTICLES]);
      ...
      return(
        ...
        <Divider />
            ...
            {articles != null? <List > {articles.map((article, i) => (
              
                <ListItemButton component="a" href={article.link}  divider={i < articles.length - 1} key={article.guid} > 
