...
const GetHelpItem: FunctionComponent<any> = ({ userProfileReducer, props }) => {
    ...
    React.useEffect(() => {
        ...
        //changeend
        axios.get('/api/gethelp/search', { params: { item_type: item_type, id: id } }).then(
            (response) => {
    ...
    let state = { feedback: '', name: 'Name', to_email: 'snehathomasdiv@gmail.com' };
    ...
    const handleConfirm = (event) => {
        if (errorText === '') {
            ...
            let resource_email_quantity =
                resource.type == 'resource' ? quantity : resource.availableDate;
